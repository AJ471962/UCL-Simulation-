...
let html =       <div style="margin:16px; padding:12px; background:#1b1b1b; border-radius:10px;">       <button onclick="prevMatchday()">Prev</button>       <button onclick="nextMatchday()">Next</button>       <button onclick="saveMatchday()">Save</button>       <button onclick="resetMatchday()">Reset</button>       <button onclick="calculateTable()">Update Table</button>       <b style="margin-left:10px;">Matchday ${currentMatchday}</b>      ;
